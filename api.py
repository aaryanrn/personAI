...
class AssistantFnc(llm.FunctionContext):
    ...
    @llm.ai_callable(description="Help the user to overcome his mental trauma with some good jokes to cheer him/her up.")
    def cheer_up(
        self,
        user: Annotated[str, llm.TypeInfo(description="The user to cheer up")],
    ):
        logger.info("cheer up - user %s", user)
        return None
